...
export default function ContactPage() {
  return (
    <main className="mx-auto min-h-screen w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <form className="mt-6 grid gap-3 rounded-xl border border-slate-200 bg-white p-5 shadow-sm sm:grid-cols-2">
        ...
        <input className="rounded-lg border border-slate-300 px-3 py-2 sm:col-span-2" placeholder="Email / Telegram" />
        <textarea
