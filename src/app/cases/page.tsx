...
const cases = [
  ...
  {
    title: "Кейс №4: Управление инфраструктурой",
    problem: "Нужен централизованный контроль работы подрядчиков «в полях».",
    solution: "Система учета и контроля проведения работ с мобильным приложением.",
    result: ["Прозрачность процессов", "Оперативный контроль статусов", "Удобная полевая работа через mobile"],
