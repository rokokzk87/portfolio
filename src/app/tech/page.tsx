...
const stack = [
  ...
  {
    title: "Frontend и UX",
    items: ["Next.js + TypeScript", "Дашборды под роли (оператор, менеджер, админ)", "Адаптивный интерфейс для desktop/mobile", "Приоритет скорости и понятности интерфейсов"],
  },
];
